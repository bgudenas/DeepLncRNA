...
mart = useMart("ensembl", dataset = "hsapiens_gene_ensembl")
map = getBM(mart = mart, attributes = c("ensembl_transcript_id","percentage_gene_gc_content", "transcript_biotype", "chromosome_name"), filters = "ensembl_transcript_id", values = rownames(df))
