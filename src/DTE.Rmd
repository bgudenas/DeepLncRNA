...
lnc_norm = density(lncRNAs$b)
pc_norm = density(pc$b)

plot(lnc_norm , lwd =3, col ="red" , xlab = expression("Log"[2]* " Fold Change"), main = "Nuclear/Cytosolic transcripts" )
lines(pc_norm, lwd = 3, col = "blue")
legend( "topleft", legend = c("LncRNA","Protein-coding"), col =c("red","blue"), lty =1, lwd =2,  bty ="n", cex = 1.2)

wilcox.test(pc$b, lncRNAs$b)
