...
library(h2o)
localH2O = h2o.init(ip="localhost", port = 54321, startH2O = TRUE, nthreads = 8, max_mem_size = "16G")
...
DNNK = h2o.deeplearning(
    ...
    l2 = 1e-5,
    model_id = "Kmer_model")
h2o.saveModel(DNNK, "./Data/Models/", force = TRUE)
h2o.shutdown(FALSE)
