...
```{r, DNN, eval = FALSE}
library(h2o)
localH2O = h2o.init(ip="localhost", port = 54321, startH2O = TRUE, nthreads = 12, max_mem_size = "16G")
...
library(h2o)
localH2O = h2o.init(ip="localhost", port = 54321, startH2O = TRUE, nthreads = 3, max_mem_size = "6G")
